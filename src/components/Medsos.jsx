...
const Medsos = () => {
    return (
        <StyledWrapper className='pb-8'>
            <div className="social-buttons">
                <a href="https://github.com/mjfardani" target="_blank" rel="noopener noreferrer" className="social-button github">
                ...
                <a href="https://www.linkedin.com/in/mjauharfardani" target="_blank" rel="noopener noreferrer" className="social-button linkedin">
                ...
                <a href="https://m.facebook.com/muhjauharfardani" target="_blank" rel="noopener noreferrer" className="social-button facebook">
          ...
          c-2.762,0-5,2.238-5,5v50.844C76.703,162.867,78.941,165.106,81.703,165.106z" />
                ...
                <a href="https://www.instagram.com/mjfardani_" target="_blank" rel="noopener noreferrer" className="social-button instagram">
